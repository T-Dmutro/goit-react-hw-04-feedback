...
return(
  <div>
    <Section><Title>Please leave feedback</Title></Section>
      <Button
      options={['good', 'neutral', 'bad']} onReview={btnReview} />
         {/* onButtonPressGood={this.handButtonPressGood}
         onButtonPressNeutral={this.handButtonPressNeutral}
         onButtonPressBad={this.handButtonPressBad} */}
    ...
    {!countTotalFeedback ? <Section><Title>There is no feedback</Title></Section> : null}
  </div>
);
        }
Button.propTypes={
...
Statistics.propTypes={
  ...
  onCountPositiveFeedbackPercentage:PropTypes.string,
